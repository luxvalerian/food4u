# Generated by Django 3.0.4 on 2020-04-23 22:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_time', multiselectfield.db.fields.MultiSelectField(choices=[('A', '9AM–10AM'), ('B', '10AM–11AM'), ('C', '11AM–12PM'), ('D', '12PM–1PM'), ('E', '1PM–2PM'), (
                    'F', '2PM–3PM'), ('G', '3PM–4PM'), ('H', '4PM–5PM'), ('I', '5PM–6PM'), ('J', '6PM–7PM'), ('K', '7PM–8PM'), ('L', '8PM–9PM'), ('M', '9PM–10PM')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.CharField(max_length=1000,
                                           null=True, verbose_name='Image URL')),
            ],
        ),
        migrations.CreateModel(
            name='Timeslot',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability_date', models.DateField(
                    null=True, verbose_name='available date')),
                ('availability', multiselectfield.db.fields.MultiSelectField(choices=[('A', '9AM–10AM'), ('B', '10AM–11AM'), ('C', '11AM–12PM'), ('D', '12PM–1PM'), ('E', '1PM–2PM'), (
                    'F', '2PM–3PM'), ('G', '3PM–4PM'), ('H', '4PM–5PM'), ('I', '5PM–6PM'), ('J', '6PM–7PM'), ('K', '7PM–8PM'), ('L', '8PM–9PM'), ('M', '9PM–10PM')], max_length=100)),
                ('customer', models.ManyToManyField(
                    through='main_app.Timeslot', to='main_app.Customer')),
                ('user', models.OneToOneField(
                    on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='main_app.Store')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
