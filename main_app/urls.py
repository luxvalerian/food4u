...
urlpatterns = [
    ...
    path('stores/<str:store_name>/detail/', views.stores_detail, name='detail'),
...
#     path('customer/<int:pk>/update/',views.update_profile, name="customer_update"),
    ...
    path('add_delivery_time/<int:user_id>/<int:volunteer_id>/', views.cart, name='add_timeslot'),
    path('cart/<int:user_id>/assoc_item/<int:item_id>/', views.assoc_item, name='assoc_item'),
